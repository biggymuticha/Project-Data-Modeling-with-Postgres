...
def process_song_file(cur, filepath):
    ...
    Parameters:
    argument1 (cur): Cursor to execute insert queries for song and artist data
    argument2 (filepath): Path of the json files containing songs data
...
def process_log_file(cur, filepath):
    ...
    Parameters:
    argument1 (cur): Cursor to execute insert queries for song and artist data
    argument2 (filepath): Path of the json log file containing songs play data
...
def process_data(cur, conn, filepath, func):
    ...
    Parameters:
    argument1 (cur): Cursor to execute insert queries for song and artist data
    argument2 (conn): Path of the json containing songs data
    argument3 (filepath): Top level folder path that contains songs or song play logs
    argument4 (func): Function to be used to process the json files
